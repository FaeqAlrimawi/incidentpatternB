...
import cyberPhysical_Incident.CyberPhysical_IncidentFactory;
 ...
 * @generated
 */
public class CyberPhysical_IncidentPackageImpl extends EPackageImpl implements CyberPhysical_IncidentPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see cyberPhysical_Incident.CyberPhysical_IncidentPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CyberPhysical_IncidentPackageImpl() {
		super(eNS_URI, CyberPhysical_IncidentFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link CyberPhysical_IncidentPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CyberPhysical_IncidentPackage init() {
		if (isInited) return (CyberPhysical_IncidentPackage)EPackage.Registry.INSTANCE.getEPackage(CyberPhysical_IncidentPackage.eNS_URI);

		// Obtain or create and register package
		CyberPhysical_IncidentPackageImpl theCyberPhysical_IncidentPackage = (CyberPhysical_IncidentPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof CyberPhysical_IncidentPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new CyberPhysical_IncidentPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theCyberPhysical_IncidentPackage.createPackageContents();

		// Initialize created meta-data
		theCyberPhysical_IncidentPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theCyberPhysical_IncidentPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CyberPhysical_IncidentPackage.eNS_URI, theCyberPhysical_IncidentPackage);
		return theCyberPhysical_IncidentPackage;
	}
	 ...
	 * @generated
	 */
	public CyberPhysical_IncidentFactory getCyberPhysical_IncidentFactory() {
		return (CyberPhysical_IncidentFactory)getEFactoryInstance();
	}
...
} //CyberPhysical_IncidentPackageImpl
