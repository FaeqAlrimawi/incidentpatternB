 ...
 * @generated
 */
public class CyberPhysical_IncidentSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public CyberPhysical_IncidentSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CyberPhysical_IncidentPackage.ACTIVITY: {
				Activity activity = (Activity)theEObject;
				T result = caseActivity(activity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.CRIME_SCRIPT: {
				CrimeScript crimeScript = (CrimeScript)theEObject;
				T result = caseCrimeScript(crimeScript);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.SCENE: {
				Scene scene = (Scene)theEObject;
				T result = caseScene(scene);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.MOTIVE: {
				Motive motive = (Motive)theEObject;
				T result = caseMotive(motive);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.GOAL: {
				Goal goal = (Goal)theEObject;
				T result = caseGoal(goal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.INTENT: {
				Intent intent = (Intent)theEObject;
				T result = caseIntent(intent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.ASSET: {
			...
			case CyberPhysical_IncidentPackage.CONNECTION: {
				Connection connection = (Connection)theEObject;
				T result = caseConnection(connection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.LOCATION: {
				Location location = (Location)theEObject;
				T result = caseLocation(location);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.RESOURCE: {
			...
			case CyberPhysical_IncidentPackage.PATH: {
				Path path = (Path)theEObject;
				T result = casePath(path);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.ACTIVITY_INITIATOR: {
				ActivityInitiator activityInitiator = (ActivityInitiator)theEObject;
				T result = caseActivityInitiator(activityInitiator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.ACTOR: {
			...
			case CyberPhysical_IncidentPackage.INCIDENT_DIAGRAM: {
				IncidentDiagram incidentDiagram = (IncidentDiagram)theEObject;
				T result = caseIncidentDiagram(incidentDiagram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.PROPERTY: {
				Property property = (Property)theEObject;
				T result = caseProperty(property);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.VULNERABILITY: {
				Vulnerability vulnerability = (Vulnerability)theEObject;
				T result = caseVulnerability(vulnerability);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.ASSET_TYPE: {
				AssetType assetType = (AssetType)theEObject;
				T result = caseAssetType(assetType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.TYPE: {
				Type type = (Type)theEObject;
				T result = caseType(type);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.UNARY_EXPRESSION: {
			...
			case CyberPhysical_IncidentPackage.BINARY_EXPRESSION: {
			...
			case CyberPhysical_IncidentPackage.CONTAINS: {
			...
			case CyberPhysical_IncidentPackage.CONNECTED_TO: {
			...
			case CyberPhysical_IncidentPackage.NOT: {
			...
			case CyberPhysical_IncidentPackage.ENTITY: {
				Entity entity = (Entity)theEObject;
				T result = caseEntity(entity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.PRECONDITION: {
			...
			case CyberPhysical_IncidentPackage.TOPOLOGICAL_RELATION: {
			...
			case CyberPhysical_IncidentPackage.EQUAL: {
			...
			case CyberPhysical_IncidentPackage.GREATER: {
			...
			case CyberPhysical_IncidentPackage.AND: {
			...
			case CyberPhysical_IncidentPackage.BIGRAPH_EXPRESSION: {
			...
			case CyberPhysical_IncidentPackage.OR: {
				Or or = (Or)theEObject;
				T result = caseOr(or);
			...
			case CyberPhysical_IncidentPackage.REACHABLE_FROM: {
			...
			case CyberPhysical_IncidentPackage.NEAR: {
			...
			case CyberPhysical_IncidentPackage.CONDITION: {
				Condition condition = (Condition)theEObject;
				T result = caseCondition(condition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CyberPhysical_IncidentPackage.POSTCONDITION: {
			...
			case CyberPhysical_IncidentPackage.FACILITATING_CONDITION: {
			...
			case CyberPhysical_IncidentPackage.INCIDENT_ENTITY: {
